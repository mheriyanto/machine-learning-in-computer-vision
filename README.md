...
+ :star: **Clean Code in Python** (M. Anaya. 2018. Packt): [**Buku**](https://www.packtpub.com/application-development/clean-code-python) | [**GitHub**](https://github.com/PacktPublishing/Clean-Code-in-Python)![GitHub stars](https://img.shields.io/github/stars/PacktPublishing/Clean-Code-in-Python?style=social)
...
+ **Products**: [playment.io](https://playment.io/) | [rectlabel.com](https://rectlabel.com/) | [scalabel.ai](https://www.scalabel.ai) | [labelbox.com](https://labelbox.com/) 
...
<ins>**Magazines**</ins>: [towardsdatascience](https://towardsdatascience.com) | [paperswithcode](https://paperswithcode.com/) | [distill](https://distill.pub/) | [xenonstack](https://www.xenonstack.com/) | [datascienceID](https://datascience.or.id/) | [tau-dataID](https://tau-data.id/) | [aidi.id](http://aidi.id/) | [idbigdata](https://idbigdata.com/official/)
